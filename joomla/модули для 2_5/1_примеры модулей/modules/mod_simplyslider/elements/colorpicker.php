...
class JFormFieldColorpicker extends JFormField
{
	...
	protected function getInput()
	{
		...
		$doc->addScript($baseurl . 'modules/mod_simplyslider/js/color-picker.js');
		...
		$scriptname	 = $this->element['scriptpath'] ?(string) $this->element['scriptpath'] : $baseurl.'modules/mod_iNowSlider/js/color-picker.js';
...
';
		...
		*/		
		...
		return '<input type="text" name="test" value="'.htmlspecialchars($this->value, ENT_COMPAT, 'UTF-8').'" name="jform[params][loaderColor]" id="jform_params_loaderColor" />';				
	}
}
