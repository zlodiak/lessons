...
class TextPad(tkinter.Frame):
    ...
    def make_tool_bar(self):
        ...
        self.tool1 = tkinter.Button(toolbar, text = 'New')
        self.tool1.pack(side = 'left')

        self.tool2 = tkinter.Button(toolbar, text = 'Open')
        self.tool2.pack(side = 'left')

        self.tool3 = tkinter.Button(toolbar, text = 'Save')
        self.tool3.pack(side = 'left')

        self.tool4 = tkinter.Button(toolbar, text = 'Close')
        self.tool4.pack(side = 'left')

        self.tool5 = tkinter.Button(toolbar, text = 'Quit')
        self.tool5.pack(side = 'right')
