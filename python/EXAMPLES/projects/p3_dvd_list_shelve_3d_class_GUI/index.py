...
class MyGui(Frame):
        def __init__(self, parent = None):
                ...
                buttonShow = Button(self, text = 'Show all records', command = self.show)
                buttonAdd = Button(self, text = 'Add new record', command = self.add)
                buttonEdit = Button(self, text = 'Edit recird', command = self.edit)  
                buttonShow.pack()
                buttonAdd.pack()
                buttonEdit.pack()
        ...
        def add(self):
                showinfo(title = 'popup', message = 'add')

        def edit(self):
                showinfo(title = 'popup', message = 'edit')
