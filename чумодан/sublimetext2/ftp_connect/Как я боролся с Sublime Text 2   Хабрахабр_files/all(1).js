...
$(document).ready(function(){
  ...
  // Preload ajax loader
  var ajaxloader = $('<img src="/images/form/ajax_loader.gif" alt="" class="ajax_loader" align="top"/>');
    ...
    $.get('/json/hubs/categories/', function(json){
              ...
              $.get('/json/hubs/category/'+alias+'/', function(json){
                  ...
                  $('.hub .checkbox', hubs).click(function(){
                      ...
                      if( hub.hasClass('subscription') ){
                        ...
                        hub_input.val(0);
                        node.attr('title', 'Подписаться на хаб');
                      }else{
                        hub.addClass('subscription');
                        hub_input.val(1);
                        node.attr('title', 'Отписаться от хаба');
                      }
          ...
          $('.category > .checkbox',hubs_category).live('click', function(){
            ...
            if( category.hasClass('full') ){
              ...
              node.attr('title', 'Подписаться на все хабы в этой категории');
              ...
              node.attr('title', 'Отписаться от всех хабов в этой категории');
            }else{
