...
/*!
 * Generated using the Bootstrap Customizer (http://getbootstrap.com/customize/?id=cb7c13da36e9ef6a9b17)
 * Config saved to config.json and https://gist.github.com/cb7c13da36e9ef6a9b17
 */
...
$(document).ready(function(){
    $(".photos").colorbox({rel:'photos', transition:"none", width:"90%", height:"90%"});
    ...
    $('#tablistComments a').click(function (e) {
      e.preventDefault()
      $(this).tab('show')
    })

    $('#enable_advanced_mode_button').click(function (e) {
      e.preventDefault();
      CKEDITOR.replace($(this).attr('data-id'));
    })

    $('[data-action="comment-reply"]').click(function(event){
        event.preventDefault();
        var form = $('#comment-form');
        var id = $(this).data('id');
        $(form).find('[name="comment[parent_id]"]').val(id);
        $(form).insertAfter('#comment-id-' + id);
    });
...
$(function(){
    $('.editor-enable').each(function(k, el){
