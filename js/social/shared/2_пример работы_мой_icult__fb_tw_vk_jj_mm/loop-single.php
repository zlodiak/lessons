<?php if ( have_posts() ) while ( have_posts() ) : the_post(); ?>
	...
	<?php else: ?>
						<a href="#comments">Нет комментариев</a>
	<?php endif ?>
					</div><!-- .entry-meta -->
				</div>
					...
					<tr>
						<td class="entry-aside">
							<div class="social_block2 clearfix">
								<div class="fb-like-outer2">
									<div class="counter" id="fb_counter"></div>
									
									<a rel="nofollow" target="blank" href="http://www.facebook.com/sharer.php?u=<?php the_permalink(); ?>">
										<img id="fb_img" src="<?php bloginfo('template_url'); ?>/images/soc_fb_save.png"  title="Поделиться ссылкой в FaceBook">
									</a>								
								</div>
								
								<div class="vk_outer2">	
									<div class="counter" id="vk_counter"></div>
								
									<a href="http://vkontakte.ru/share.php?url=<?php the_permalink(); ?>" target="_blank" rel="nofollow">
										<img id="vk_img" src="<?php bloginfo('template_url'); ?>/images/soc_vk_save.png" title="Поделиться ссылкой в ВКонтакте" >
									</a>									
								</div>	

								<div class="tw_outer2">																								
									<a href="https://twitter.com/share" class="twitter-share-button"  data-via="your_screen_name" data-lang="en" data-related="anywhereTheJavascriptAPI" data-count="vertical" target="_blank" title="Поделиться ссылкой в Twitter">Tweet</a>
									<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="https://platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>									
								</div>								
								
								<div class="mm_outer2">	
									<a target="_blank" href="http://connect.mail.ru/share" title="Поделиться ссылкой в МойМир"></a>
								</div>
								
								<div class="jj_outer2">	
									<a target="_blank" rel="nofollow" href="http://www.livejournal.com/update.bml?event=<?php the_permalink(); ?>&subject=<?php the_title(); ?>" >
										<img id="jj_img" src="<?php bloginfo('template_url'); ?>/images/soc_jj_save.png" title="Поделиться ссылкой в livejournal.com">
									</a>								
								</div>	
		...
		<?php endif; ?>
							...
							<div class="entry-utility">
								<?php imbalance2_tags() ?>
								<?php edit_post_link('Редактировать запись', '<span class="edit-link">', '</span>' ); ?>
							</div><!-- .entry-utility -->
							...
							<div id="social">
								...
								<div class="fb_like_outer">
									<div id="fb-root"></div>
									<script src="http://connect.facebook.net/ru_RU/all.js#xfbml=1"></script>
									<fb:like href="<?php echo 'http://'.$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI'] ?>" send="false" width="450" show_faces="false" font=""></fb:like>
								</div>
							</div>
						</td>
					</tr>
