...
desc: графический компонент для преобразования списка в карусель с возможностью прокрутки при помощи стрелок-указателей. слайды карусели должны быть одинаковой длины. задача реализовать на чистом javascript
version 1.1
*/
